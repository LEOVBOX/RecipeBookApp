...
final class RecipeView: UIView {
    ...
    private lazy var ingredientsView: IngredientsCollectionView = {
        let cell = IngredientViewCell.self
        let ingredientsCollectionView = IngredientsCollectionView(dependencies: .init(cell: cell, downloadable: presenter.saved, scrollable: false))
...
private extension RecipeView {
    ...
    func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            ingredientsView.topAnchor.constraint(equalTo: descriptionStack.bottomAnchor, constant: 2*Constants.padding),
